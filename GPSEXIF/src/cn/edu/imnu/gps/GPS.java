...
public class GPS {
	    ...
	    public static void main(String[] args) {
	        String lat="40° 48' 46.44\"";
	        String lng="111° 39' 51.12\"";
	    ...
	    public static String getLocationByBaiduMap(String longitude,String latitude) throws Exception {
	        ...
	        String addrJson = geturl("http://api.map.baidu.com/geocoder/v2/?ak=7GAxnzcDaWjbiLx19K3Hge1OKBuK5alo&location=" + lat + "," + lng + "&output=json&pois=1");
